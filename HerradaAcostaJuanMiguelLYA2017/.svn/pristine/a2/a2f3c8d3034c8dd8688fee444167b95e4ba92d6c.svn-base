...
public class CoeficienteBinTest{
	...
	/*@Test
	public void testCoefBinomialCero() {
		solCB = new CoeficienteBin(0,5); 
		assertTrue(solCB.coefBinomialRecursivo() == 0 );
		assertTrue(solCB.coefBinomialProgDinam() == 0 );
		solCB.setN(1); // (1,5)
		assertTrue(solCB.coefBinomialRecursivo() == 0 );
		assertTrue(solCB.coefBinomialProgDinam() == 0 );
